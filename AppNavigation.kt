...
sealed class Screen(val route: String, val titleResId: Int, val icon: androidx.compose.ui.graphics.vector.ImageVector?) {
    ...
    object Kick : Screen("kick", R.string.nav_kick, Icons.Filled.ThumbUp) // Or footprint if available
    object Nutrition : Screen("nutrition", R.string.nav_nutrition, Icons.Filled.List)
